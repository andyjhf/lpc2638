...
/*==============================Function Data==========================================*/
	...
	{	void (*Asc2Bcd)(uint8 *Asc,uint8 *BCD,uint8 SizeofAsc);	 //ASC
		...
		void (*HexBuf2Asc)(uint8 *Hex,uint8 *Asc,uint16 SizeofHex);
		...
		void (*Algorism2BCD)(uint32 Hex,uint8 *BCD,uint8 SizeofBCD);
		uint32 (*BCD2Algorism)(uint8 *BCD,uint8 SizeofBCD);
...
/*==============================Static Function========================================================*/
		...
		static void HexBuf2Asc(uint8 *Hex,uint8 *Asc,uint16 SizeofHex);
		static uint32 Asc2Hex(uint8 *Asc,uint8 SizeofAsc);
		static uint8 Hex2Asc(uint32 Hex,uint8 *Asc);
		static void Algorism2BCD(uint32 Hex,uint8 *BCD,uint8 SizeofBCD);
		static uint32 BCD2Algorism(uint8 *BCD,uint8 SizeofBCD);
...
/*==================================================函数输出====================================================*/		
		...
		{	Asc2Bcd,Bcd2Asc,Asc2Algorism,Algorism2Asc,Asc2HexBuf,HexBuf2Asc,Asc2Hex,Hex2Asc,Asc2Float,Bcd2Hex,Hex2Bcd,JugeAscBcd,
			...
			MemSpace,JugeBufType,PhoPdu,gsmEncode7bit,PduNumber,ExpPdu,Bit72Bit8,GetCsq,StrToUni,UniToStr,INT322IPAsc,IPAsc2INT32,IP2Char,Char2IP,
			LookBufInLength,Value32,Algorism2BCD,BCD2Algorism
