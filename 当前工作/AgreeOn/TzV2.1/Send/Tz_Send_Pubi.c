...
{	uint16 DataLen=0,j;
	...
	{	OutBuf[DataLen++]=8;
		CN_st_Fun_AscNumber.MoveByte(OutBuf+DataLen,ptst_AgreeOn_Agree_Par->DataLog,8);
		*ReDataLen=9;
	}
	else if(ParID==De_SetPar_SetDataScotomaLog)	
	{	OutBuf[DataLen++]=8;
		CN_st_Fun_AscNumber.MoveByte(OutBuf+DataLen,ptst_AgreeOn_Agree_Par->DataScotomaLog,8);
		*ReDataLen=9;
	}
	...
	{	OutBuf[DataLen++]=2;
		OutBuf[DataLen++]=ptst_AgreeOn_Agree_Par->CN_Vo_st_Waring_Par.WartingVl;
