...
{	union 
	...
	{	CN_st_Fun_File.ReadRecoder(CN_st_File_fd.MessageParfd,0,&un_Par.CN_st_Message_ComPar);
		CN_st_Fun_AscNumber.MoveByte(un_Par.CN_st_Message_ComPar.CN_st_Message_Phone.CenMessageSev,ptst_AgreeOn_Agree_Par->CerSevPhone,
	...
	{	CN_st_Fun_File.ReadRecoder(CN_st_File_fd.MessageParfd,0,&un_Par.CN_st_Message_ComPar);
		CN_st_Fun_AscNumber.MoveByte(un_Par.CN_st_Message_ComPar.CN_st_Message_Phone.CentrMessPhone1,ptst_AgreeOn_Agree_Par->CenPhone,
