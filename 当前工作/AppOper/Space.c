...
{	st_Parameter_Table	CN_st_Parameter_Table;
	...
	CN_st_Fun_RunLen.Open(&CN_st_Appair_Data,(st_Affair_RunLen	*)&CN_Ba_GetGps,&fd);
	...
	{	CN_st_Appair_Data.Len=CN_st_Parameter_Table.CN_st_AgreeOn_Agree_Track.Space;
		CN_st_Fun_RunLen.Open(&CN_st_Appair_Data,(st_Affair_RunLen	*)&CN_Ba_Space_Track,&fd);	
	}
	...
	{	CN_st_Appair_Data.Len=CN_st_Parameter_Table.CN_Work_st_AgreeOn_Agree_Track.Space;
		CN_st_Fun_RunLen.Open(&CN_st_Appair_Data,(st_Affair_RunLen	*)&CN_Ba_Space_WorkParSpace,&fd);	
	}
...
{	st_File_Gps	CN_st_File_Gps;
	...
	App_CN_st_WorkFlow_Table.CN_st_WorkVal_Tabel.CN_st_AgreeOn_SetVidType_Par.Mileage=
	CN_st_File_Gps.Milage;
