...
{	const st_Affair_Phone	CN_st_Affair_Phone={ptFunNewPhone,ptFunHupWork};
...
{	st_AgreeOn_Driver	CN_st_AgreeOn_Driver;
	...
	CN_st_st_AgreeOn_Dev_Par.Buf=&CN_st_AgreeOn_Driver;
		...
		{	DataLen=CN_st_Fun_AscNumber.Strsize(CN_st_AgreeOn_Driver.CN_st_AgreeOn_Driver_Par[i].Phone);
			...
			{	CN_st_Fun_AscNumber.MoveByte(MessageCut,"登陆失败!",9);
				...
				{	if(CN_st_Fun_AscNumber.CompareBuf(App_CN_st_WorkFlow_Table.DriverID,
					CN_st_AgreeOn_Driver.CN_st_AgreeOn_Driver_Par[i].ID,sizeof(CN_st_AgreeOn_Driver.CN_st_AgreeOn_Driver_Par[i].ID))==0)
						break;
				}
				DataLen=CN_st_Fun_AscNumber.Strsize(CN_st_AgreeOn_Driver.CN_st_AgreeOn_Driver_Par[i].Phone);
				if(DataLen>15)
					DataLen=15;
				CN_st_Fun_AscNumber.MoveByte(MessageCut+9,CN_st_AgreeOn_Driver.CN_st_AgreeOn_Driver_Par[i].Phone,
				DataLen);
				DataLen+=9;
...
{	st_Display_Order_Phone	CN_st_Display_Order_Phone;
	...
	CN_st_Display_Send.SendData=&CN_st_Display_Send;
