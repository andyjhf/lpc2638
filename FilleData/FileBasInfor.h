...
/*=========================================工作参数表===========================================================*/
	...
	{	{	
			...
			{De_WordPar_NoAdree,De_WordPar_Close},				//无线开关量1
			...
			{De_WordPar_NoAdree,De_WordPar_Close},				//ACC累计时间
			...
			{De_WordPar_NoAdree,De_WordPar_Close},				//无线传感器温度1
...
/*=========================================基本参数配置表=======================================================*/
	...
	{	{De_Agree_Track_ComMod_IP,0,0,0},										//追踪参数
		{De_Agree_Track_ComMod_IP,0x0f,0x78,0},									//工作参数追踪参数
		{{255,255},{255,255},{255000,255}},										//报警值
		{0,0},																	//休眠值
		{	{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x02},							//数据查询日志
			{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x02}							//盲区补偿日志
		},																		//数据查询类型
		{0xff,0xffff,30},														//车辆参数
		...
		De_Agree_Par_TaskVid_No,
		De_st_Parameter_Table_HelpWaring_No,
		De_st_Parameter_Table_Contrl_No,
		{De_AgreeOn_Vid_Fun_Close,De_AgreeOn_Vid_Fun_Close,De_AgreeOn_Vid_Fun_Close,De_AgreeOn_Vid_Fun_Close,De_AgreeOn_Vid_Fun_Close},	//是否拍照																	//拍照类型
		10*60																	//预约订单时间								
	};
/*======================================IP通讯参数表===========================================================*/
