...
/*========================================Data Define===========================================================*/
	...
	typedef struct
	{	uint16 (*Init)(void);
		uint16 (*Open)(uint16 Par,st_Affair_Sensor	*ptst_Affair_Sensor,uint8 *fd);
		uint16 (*Write)(uint8 fd,void *SendBuf,void *AgreeBuf);
...
/*============================================Pubic Ram=========================================================*/	
	...
	const st_Fun_SensorContr	CN_st_Fun_SensorContr={Init,Open,Write,Close};
#else
