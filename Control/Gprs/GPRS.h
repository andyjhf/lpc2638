...
/*==========================================Include File====================================================*/	
	#include "..\..\APP\config.h"											//LPC2368寄存器引用
 	#include "stdlib.h"	
		...
		#include "..\..\HardWare\RTC\RTC.h"								//引用时间计时
...
/*=========================================Define Data======================================================*/
	...
	/*----------------------------------------系统状态-------------------------------------------------*/
//		#define De_Gprs_ModelState_Ok											0
//		#define De_Gprs_ModelState_Erro											1
	...
	/*++++++++++++++++++++++++++++++++操作系统有关++++++++++++++++++++++++++++++++++++++++*/
		...
		#define De_Gprs_Task												5
		#define De_Gprs_Stk													384//1536
		#define De_Gprs_TaskDly												20				//延时调度时间
	#endif
/*============================================Data Define=====================================================*/
	/*++++++++++++++++++++++++++++++++++++++++数据结构定义+++++++++++++++++++++++++++++++++++++++++++*/
		/*---------------------------------对外使用结构体----------------------------------------*/
...
/*		typedef struct
		...
		{	void (* ptFunNewPhone)(uint8 *Phone);					//新电话事件
			...
			void (* ptFunMostPhone)(st_Data_Gprs_Call *ptst_Data_Gprs_Call);
		...
		{	uint16 (*	Init)(void);								//初始化本页
			...
			uint16 (*	GetCurIPState)(uint8 fd,uint8 *State);
...
/*========================================全局变量定义=========================================================*/
		...
		static OS_STK		*GprsTaskStk=(OS_STK *)(De_Gprs_STK_Ram);//[De_Gprs_Stk];
		uint8 DateTimer[7];	 
...
//		st_HardWare_SeeTCPData	CN_st_HardWare_SeeTCPData;
	 /*------------------------------------------变量初值定义------------------------------------------------------*/
		...
		SendIP1,SendPhone1,SetVolume1,GetSysState1,GetMessageState1,GetPhoneState1,GetIPState1,DNSRIP1,GetIpPro1,GetCurIPState};
	#else
