...
{	union 
	...
	{	CN_st_Fun_File.ReadRecoder(CN_st_File_fd.MessageParfd,0,&un_Par.CN_st_Message_ComPar);
		CN_st_Fun_AscNumber.MoveByte(ptst_AgreeOn_Agree_Par->CerSevPhone,
	...
	{	if(CN_st_Fun_File.ReadRecoder(CN_st_File_fd.Driverfd,0,&un_Par.CN_st_AgreeOn_Driver)!=De_Suc_File)
