...
/*===================================Define Data=======================================================*/
    #define  OS_ADD  	//此变量如定义，则在操作系统下使用，如果不定义则在前后台系统上使用
		...
		#define  OS_Message_Uart4					//开启串口4消息模式
	#endif
	...
	#define De_Erro_Uart_Init_4					De_Erro_Uart_Init_3+1
	#define De_Erro_Uart_NoPort					De_Erro_Uart_Init_4+1			//无此端口
	...
	#define De_Erro_Uart4_NoData				De_Erro_Uart3_NoData+1	
	...
	#define De_Uart_Port_4							4				//串口3

	/*+++++++++++++++++++++++++++++++++++++Ram地址分配++++++++++++++++++++++++++++++++++++++++++*/
	#define De_Uart_RecMaxSize					1024	 						//uart最大接受的字节数量
	...
	#define De_Uart4Ram							De_Uart3Ram+De_Uart_RecMaxSize	//串口3接受缓冲首地址
	...
	/*++++++++++++++++++++++++++++++++++++HardWareI/O+++++++++++++++++++++++++++++++++++++++++++*/
		...
		/*串口4发送端口*/
		#define De_Uart_Send_Port_4 			31    	//  P0.27  LED     LED 指示灯
		#define De_Uart_Send_Down        		IODIR1  |= ((uint32 )0x00000001<<De_Uart_Send_Port_4);IOCLR1 |= ((uint32 )0x00000001<<De_Uart_Send_Port_4)
		#define De_Uart_Send_Up	       			IODIR1  |= ((uint32 )0x00000001<<De_Uart_Send_Port_4);IOSET1 |= ((uint32 )0x00000001<<De_Uart_Send_Port_4)
  	
		#define De_Uart_Br_2400				Fpclk/2400-100
		#define De_Uart_Br_4800				Fpclk/4800
		#define De_Uart_Br_9600				Fpclk/9600
		#define De_Uart_Br_19200			Fpclk/19200
		#define De_Uart_Br_38400			Fpclk/38400
		#define De_Uart_Br_43000			Fpclk/43000
		#define De_Uart_Br_56000			Fpclk/56000
		#define De_Uart_Br_57600			Fpclk/57600
		#define De_Uart_Br_115200			Fpclk/115200
...
/*======================================static Function======================================================*/
		...
		static uint16 Open4(st_Da_Uart	*ptst_Da_Uart);
...
/*======================================Public Ram============================================================*/
		...
		uint8 ByteRec = 0;
		uint8 ByteSend = 0;
		uint8 BitCountSend=0;
		uint32 Uart4BaudRate;
		uint8 UartRevState=1;
		uint8 Uart4Rev[12];
		uint8 AgreeByte;
	
		#ifdef OS_ADD
			OS_EVENT 		*Uart0UseSem=NULL;						//获取串口使用权
			OS_EVENT 		*Uart1UseSem=NULL;						//获取串口使用权
			OS_EVENT 		*Uart2UseSem=NULL;						//获取串口使用权
			OS_EVENT 		*Uart3UseSem=NULL;						//获取串口使用权
			OS_EVENT 		*Uart4UseSem=NULL;						//获取串口使用权
		#endif	
		#ifdef OS_Message_Uart0
			OS_EVENT 		*Uart0RxSem=NULL;						//获取接收送使用权
		#endif
		
		#ifdef OS_Message_Uart1
			OS_EVENT 		*Uart1RxSem=NULL;						//获取接收送使用权
		#endif
		
		#ifdef OS_Message_Uart2	
			OS_EVENT 		*Uart2RxSem=NULL;						//获取接收送使用权
		#endif
		#ifdef OS_Message_Uart3
			OS_EVENT 		*Uart3RxSem=NULL;						//获取接收送使用权
		#endif
		#ifdef OS_Message_Uart4
			OS_EVENT 		*Uart4RxSem=NULL;						//获取接收送使用权
		#endif
		//接受缓冲区
		...
		uint8 *ptUart4ReBuf=(uint8 *)(De_Uart4Ram);

		//队列所用变量
		uint16 UART0_RxHead,UART0_RxTail,UART1_RxHead,UART1_RxTail,UART2_RxHead,UART2_RxTail,UART3_RxHead,UART3_RxTail,UART4_RxHead,UART4_RxTail;
