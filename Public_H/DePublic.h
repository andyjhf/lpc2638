...
/*============================利用以太网口的RAM================================================*/	
	...
	#define De_Timer_STK			De_TzV21_Ram+2048  				//时间空间
	#define De_TzV21_STK			De_Timer_STK+1024				//协议堆栈使用
	#define De_GpsAndMi				De_TzV21_STK+1024				//GpsAndMi
	#define De_FTP_STK_Ram			De_GpsAndMi+1024
	#define De_IPData_Ram			De_FTP_STK_Ram+1024
	#define De_Gprs_STK_Ram			De_IPData_Ram+2048				//协议
	//#define De_Sensor_STK			De_Gprs_STK_Ram+1536
