...
{	uint8 j,k;
	...
	{ 	CN_st_Fun_AscNumber.ClsArray(ptst_AgreeOn_Agree_Par_Cut->GreenWord,sizeof(ptst_AgreeOn_Agree_Par_Cut->GreenWord));
	...
	{	CN_st_Fun_AscNumber.ClsArray(ptst_AgreeOn_Agree_Par_Cut->ListePhone,sizeof(ptst_AgreeOn_Agree_Par_Cut->ListePhone));
	...
	{	CN_st_Fun_AscNumber.ClsArray(ptst_AgreeOn_Agree_Par_Cut->ResetPhone,sizeof(ptst_AgreeOn_Agree_Par_Cut->ResetPhone));
	...
	{	CN_st_Fun_AscNumber.ClsArray(ptst_AgreeOn_Agree_Par_Cut->CerSevPhone,sizeof(ptst_AgreeOn_Agree_Par_Cut->CerSevPhone));
	...
	{	CN_st_Fun_AscNumber.ClsArray(ptst_AgreeOn_Agree_Par_Cut->CenPhone,sizeof(ptst_AgreeOn_Agree_Par_Cut->CenPhone));
	...
	{	CN_st_Fun_AscNumber.ClsArray(ptst_AgreeOn_Agree_Par_Cut->DataLog,sizeof(ptst_AgreeOn_Agree_Par_Cut->DataLog));
		if(Buf[7]&0x01)	   //追踪
			ptst_AgreeOn_Agree_Par_Cut->DataLog[0]=1;
		if(Buf[7]&0x02)	   //工作参数
			ptst_AgreeOn_Agree_Par_Cut->DataLog[1]=1;
    	if(Buf[7]&0x04)	  //照片
			ptst_AgreeOn_Agree_Par_Cut->DataLog[2]=1;
		if(Buf[7]&0x08)	 //压缩回传
			ptst_AgreeOn_Agree_Par_Cut->DataLog[3]=1;
	}
	else if(WordPar==De_SetPar_SetDataScotomaLog)						//盲区补偿数据
	{	CN_st_Fun_AscNumber.ClsArray(ptst_AgreeOn_Agree_Par_Cut->DataScotomaLog,sizeof(ptst_AgreeOn_Agree_Par_Cut->DataScotomaLog));
		if(Buf[7]&0x01)	   //追踪
			ptst_AgreeOn_Agree_Par_Cut->DataScotomaLog[0]=1;
		if(Buf[7]&0x02)	   //工作参数
			ptst_AgreeOn_Agree_Par_Cut->DataScotomaLog[1]=1;
    	if(Buf[7]&0x04)	  //照片
			ptst_AgreeOn_Agree_Par_Cut->DataScotomaLog[2]=1;
		if(Buf[7]&0x08)	 //压缩回传
			ptst_AgreeOn_Agree_Par_Cut->DataScotomaLog[3]=1;
	}  
	...
	else if(WordPar==De_SetPar_ComFac)					    //恢复出厂值
	{	FileData_BackSet();
	...
	{ 	ptst_AgreeOn_Agree_Par_Cut->CN_Vo_st_Waring_Par.WartingVl=Buf[0]*1000;
